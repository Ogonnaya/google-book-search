        ...
        {window.location.pathname === "/" ? (
          <div>
            ...
            <SearchResult>
              {this.state.results.length ? (
                    ...
                    <BookItemCard
                      ...
                      thumbnail={
                        book.volumeInfo.imageLinks
                          ...
                          : "https://images.unsplash.com/photo-1517770413964-df8ca61194a6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2250&q=80"
                      }
                ...
                <h3 className="no-results">No results yet. Start searching!</h3>
              )}
            </SearchResult>
          </div>
        ) : (
          <SaveCard>
            {this.state.savedBooks.length ? (
              ...
              <h3>No saved books yet. Start searching!</h3>
            )}
          </SaveCard>
        )}
      </div>
